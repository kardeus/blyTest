...
public abstract class Hilt_HomeFragment<B extends ViewDataBinding> extends BaseFragment<B> implements GeneratedComponentManagerHolder {
  ...
  Hilt_HomeFragment(int layoutRes) {
    super(layoutRes);
  }
