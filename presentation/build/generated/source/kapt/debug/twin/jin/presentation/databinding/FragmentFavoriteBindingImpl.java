...
public class FragmentFavoriteBindingImpl extends FragmentFavoriteBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((twin.jin.presentation.ui.main.MainSharedViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable twin.jin.presentation.ui.main.MainSharedViewModel ViewModel) {
