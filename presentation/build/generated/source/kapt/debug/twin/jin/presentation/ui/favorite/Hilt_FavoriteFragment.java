...
public abstract class Hilt_FavoriteFragment<B extends ViewDataBinding> extends BaseFragment<B> implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavoriteFragment(int layoutRes) {
    super(layoutRes);
  }
